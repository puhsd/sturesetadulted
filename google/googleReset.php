...
function getClient() {
  ...
  $client->setAuthConfig("/Users/slobodan.stevanovic/Sites/google/client_secret.json");
  $client->setAccessType('offline');

  // Load previously authorized credentials from a file.
  $credentialsPath = expandHomeDirectory(CREDENTIALS_PATH);
  // $credentialsPath = "/Users/slobodan.stevanovic/.credentials/admin-directory_v1-php-quickstart.json";
...
function updateGooglePassword($email, $password){
